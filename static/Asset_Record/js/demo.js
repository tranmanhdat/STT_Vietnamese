...
function startRecording() {
	...
	*/
	...
	recordButton.innerText = "Dừng lại"
}
...
function createDownloadLink(blob,encoding) {
    ...
    xhr.onload=function(e) {
        if(this.readyState === 4) {
			console.log("Server returneddemo2: ",e.target.responseText);
...
function handleUploadFile()
{
    ...
    xhr.onload=function(e) {
        if(this.readyState === 4) {
			console.log("Server returnedhandle: ",e.target.responseText);
			document.getElementById("textTrans").value = e.target.responseText;
			document.getElementById("progress").style.display = 'none'
        }
    };
